...
This book is for anyone who wants to build [[Web/application]]s. Whether you’ve had just a little bit of JavaScript exposure or whether you’re a seasoned professional with dozens of [[js/React]] and [[Redux]] applications under your belt, WebAssembly has the potential to change the way you build apps and the power of those applications in a way that few technologies before ever have.
